...
# import interior_designing_material_database
...
# def interior_material(x, lbl):
    
    
#     global my_tree1
    
#     label1 = lbl(x, text="Interior Designing Material Cost Allocation")
...
# def interior_material1(lbl, ent, btn, b):
#     def datetoday():
...
#     interior_designing_material_database.dbconnect()

#     class InventoryInterior_handling:
...
#             interior_designing_material_database.dbentry(dateentry.get(), supplier_name_entry.get(), supplier_id_entry.get(),inventory_entry.get(),inventory_id_entry.get(),unit_entry.get(),quantity_entry.get(),price_entry.get(), total_entry.get())
...
#             selected = my_tree1.focus()
#             values = my_tree1.item(selected, "values")
#             interior_designing_material_database.dbdelete(values[0])
#             my_tree1.delete(*my_tree1.get_children())
...
#             interior_designing_material_database.dbupdate(dateentry.get(), supplier_name_entry.get(), supplier_id_entry.get(),inventory_entry.get(),inventory_id_entry.get(),unit_entry.get(),quantity_entry.get(),price_entry.get(), total_entry.get(), values[0])
...
#         def fetching(self):
#             data = interior_designing_material_database.dbfetch()
#             # mylb.delete(0, END)
...
#     record1 = InventoryInterior_handling()
#     # bind
