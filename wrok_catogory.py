...
def work(x, lbl):
    ...
    label1 = lbl(x, text="Expense Record Book")
    ...
    # define our columns
    my_tree3['columns'] = ("id", "work_name", "discription")

    # format our columns
    my_tree3.column("#0", width=0, stretch=NO)
    my_tree3.column("id", anchor=CENTER, width=50)
    my_tree3.column("work_name", anchor=W, width=140)
    ...
    my_tree3.heading("work_name", text="Work Name", anchor=W)
...
def work1(lbl, ent, btn, b):
    ...
    class work_handling:
        ...
        def entering(self):
            ...
            work_database.dbentryexp(name_entry2.get(), address_entry2.get())
        ...
        def deleting(self):
            ...
            selected = my_tree3.focus()
            values = my_tree3.item(selected, "values")
            work_database.dbdeleteexp(values[0])
            my_tree3.delete(*my_tree3.get_children())
        ...
        def updating(self):
            ...
            try:
                ...
                work_database.dbupdatexp(name_entry2.get(), address_entry2.get(), values[0])
            except:
                print("Error detected")
