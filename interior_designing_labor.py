...
#     # define our columns
#     my_tree1['columns'] = ("id","date_and_time","customer_name","customer_id", "employee_name","employee_id" "amount", "estimate", "total")
...
#     my_tree1.column("employee_id", anchor=CENTER, width=100)
    
#     my_tree1.column("amount", anchor=CENTER, width=50)
#     my_tree1.column("estimate", anchor=CENTER, width=50)
...
#     my_tree1.heading("supplier_id", text="employee_name", anchor=CENTER)
#     my_tree1.heading("amount", text="Quantity", anchor=CENTER)
#     my_tree1.heading("estimate", text="Price", anchor=CENTER)
...
#     interior_designing_labor_database.dbconnect()

#     class InteriorLabor_handling:
...
#             interior_designing_labor_database.dbentry(dateentry.get(), supplier_name_entry.get(), supplier_id_entry.get(),inventory_entry.get(),inventory_id_entry.get(),unit_entry.get(),emp_entry.get(),quantity_entry.get(),price_entry.get(), total_entry.get())
...
#             selected = my_tree1.focus()
#             values = my_tree1.item(selected, "values")
#             interior_designing_labor_database.dbdelete(values[0])
#             my_tree1.delete(*my_tree1.get_children())
...
#             interior_designing_labor_database.dbupdate(dateentry.get(), supplier_name_entry.get(), supplier_id_entry.get(),inventory_entry.get(),inventory_id_entry.get(),unit_entry.get(), emp_entry.get(),quantity_entry.get(),price_entry.get(), total_entry.get(), values[0])
...
#         def fetching(self):
#             data = interior_designing_labor_database.dbfetch()
#             # mylb.delete(0, END)
...
#     record1 = InteriorLabor_handling()
#     # bind
