...
def construction(x, lbl):
    ...
    label1 = lbl(x, text="Expense Allocation")
    ...
    # define our columns
    my_tree1['columns'] = ("id","date_and_time","customer_name", "customer_id", "expense_name", "expense_id", "total")
    ...
    my_tree1.column("expense_name", anchor=W, width=160)
    my_tree1.column("expense_id", anchor=CENTER, width=50 )
    ...
    my_tree1.heading("expense_name", text="Expense Name", anchor=W)
    my_tree1.heading("expense_id", text="Expense ID", anchor=CENTER)
...
def construction1(lbl, ent, btn, b):
    ...
    class InventoryPurchase_handling:
        ...
        def entering(self):
            ...
            expdatabase.dbentry(dateentry.get(), supplier_name_entry.get(), supplier_id_entry.get(),inventory_entry.get(),inventory_id_entry.get(), total_entry.get())
        ...
        def updating(self):
            ...
            expdatabase.dbupdate(dateentry.get(), supplier_name_entry.get(), supplier_id_entry.get(),inventory_entry.get(),inventory_id_entry.get(), total_entry.get(), values[0])
